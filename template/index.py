...
diabetes_model = pickle.load(open('multiple_disease_prediction_app/trained_model/diabetes_trained_model.sav','rb'))
diabetes_standard_scaler = pickle.load((open('multiple_disease_prediction_app/trained_model/diabetes_standard_scaler.sav','rb')))
heart_disease_model = pickle.load(open('multiple_disease_prediction_app/trained_model/heart_disease_trained_model.sav','rb'))
# Diabetes
